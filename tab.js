...
function updateClock() {
  ...
  addSearch('rutor', function(s) {
    window.location.href = 'http://rutor.org/search/' + s;
  });
  //addSearch('weather', function(s) {
    //window.location.href = 'http://www.wunderground.com/cgi-bin/findweather/getForecast?query=' + s;
 // });
  addSearch('rutracker', function(s) {
    window.location.href = 'http://rutracker.org/forum/tracker.php?nm=' + s;
  });
  addSearch('kat', function(s) {
    window.location.href = 'https://kat.cr/usearch/' + s;
  });
  addSearch('eztv', function(s) {
    window.location.href = 'https://eztv.ag/search/' + s;
  });
